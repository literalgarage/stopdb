# Generated by Django 5.1 on 2024-08-23 00:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reported_year', models.IntegerField(blank=True, default=None, null=True)),
                ('reported_month', models.IntegerField(blank=True, default=None, null=True)),
                ('reported_day', models.IntegerField(blank=True, default=None, null=True)),
                ('school_responded', models.BooleanField()),
                ('school_response_year', models.IntegerField(blank=True, default=None, null=True)),
                ('school_response_month', models.IntegerField(blank=True, default=None, null=True)),
                ('school_response_day', models.IntegerField(blank=True, default=None, null=True)),
